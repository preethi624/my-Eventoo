...
router.get('/dashboardUsers', middleware_di_1.authMiddlewarwSet.adminOnly, adminUser_di_1.adminController.getDashboardUsers.bind(adminUser_di_1.adminController));
