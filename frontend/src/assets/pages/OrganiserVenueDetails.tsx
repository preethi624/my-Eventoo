        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="relative h-96 lg:h-[500px]">
                {venue.images.length > 0 ? (
                  <>
                    <img
                      src={`http://localhost:3000/${venue.images[currentImageIndex]?.replace('\\', '/')}`}
                      alt={venue.name}
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h1 className="text-4xl font-bold text-gray-900 mb-6">{venue.name}</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{venue.city}, {venue.state} - {venue.pincode}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{venue.contactPerson}</p>
                  </div>
                </div>
              </div>
              ...
              {/* Facilities */}
              {venue.facilities && venue.facilities.length > 0 && venue.facilities[0] !== '' && (
                <div>
            ...
            <div className="sticky top-8">
              <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-gray-100">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600">Get quote for your event</p>
                </div>
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm text-gray-700">{venue.contactPerson}</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm text-gray-700">{venue.email}</span>
                    </div>
                    {venue.website && (
                      <div className="flex items-center space-x-3">
                        <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href={venue.website} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-600 hover:text-blue-800">
                          Visit Website
                        </a>
                      </div>
                    )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-gray-900">Contact {venue.name}</h3>
              <button
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <button className="text-blue-600 hover:text-blue-800 font-medium">Email</button>
              </div>
              {venue.website && (
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                  ...
                  <a href={venue.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 font-medium">
                    Visit
                  </a>
                </div>
              )}
