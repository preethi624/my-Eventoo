    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="relative pt-24 pb-8 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-50 border border-red-200 rounded-full text-red-600 text-sm font-semibold mb-4">
            <Ticket className="w-4 h-4" />
            MY TICKETS
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-2">
            Your <span className="text-red-500">Event Tickets</span>
          </h1>
          <p className="text-lg text-gray-600">Access and manage all your event passes in one place</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6 shadow-sm">
            ...
            <div className="relative">
              <div className="flex items-center bg-gray-50 rounded-xl border border-gray-300 overflow-hidden">
                ...
                <select
                  ...
                  className="pl-12 pr-8 py-3 bg-transparent text-gray-900 appearance-none cursor-pointer focus:outline-none w-full"
                >
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span className="text-gray-600 text-sm font-medium">Rows per page:</span>
              <select
                value={limit}
                onChange={(e) => {
                ...
                className="px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-red-500 appearance-none cursor-pointer"
              >
              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4">
                    {ticket.checkedIn ? (
                      <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-green-100 text-green-700 border border-green-300 shadow-sm">
                        <CheckCircle className="w-3 h-3 mr-1" />
                        Checked In
                      </span>
                    ) : isUpcoming(ticket.event.date) ? (
                      <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-blue-100 text-blue-700 border border-blue-300 shadow-sm">
                        <Clock className="w-3 h-3 mr-1" />
                        Upcoming
                      </span>
                    ) : (
                      <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-gray-100 text-gray-700 border border-gray-300 shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-xl font-semibold shadow-md transition-all flex items-center justify-center gap-2"
                    >
                    ...
                    <button
                      ...
                      className="ml-2 p-2 bg-gray-50 hover:bg-gray-100 text-gray-600 hover:text-gray-900 rounded-xl transition-all border border-gray-300"
      ...
      {selectedTicket && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-3xl max-w-md w-full p-8 border border-gray-200 shadow-2xl relative">
            <div className="relative">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-sm">{selectedTicket.event.venue}</p>
              </div>

              <div className="bg-gray-50 rounded-2xl p-6 mb-6 flex items-center justify-center border border-gray-200">
                <QRCodeSVG
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-6 border border-gray-200">
                <p className="text-xs text-gray-500 mb-2 text-center font-semibold">QR Token</p>
                <p className="text-xs font-mono text-gray-900 bg-white px-3 py-2 rounded-lg border border-gray-300 text-center break-all">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-red-500 hover:bg-red-600 text-white rounded-xl font-semibold shadow-md transition-all flex items-center justify-center gap-2"
                >
                  <Download className="w-4 h-4" />
                  Download
                </button>
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-semibold border border-gray-300 transition-all"
                >
                  Close
                </button>
              </div>
