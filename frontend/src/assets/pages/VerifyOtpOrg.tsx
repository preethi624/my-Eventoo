...
export interface VerifyOtpOrgPayload{
    name:string,
    email:string,
    password:string,
    otp:string
...
const VerifyOtpOrg: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await authRepository.verifyOtpOrganiser({ name, email, password, otp });
