...
const ShowsAndEvents: React.FC = () => {
  ...
  useEffect(() => {
    fetchEvents();
  }, [searchLocation,selectedCategory,maxPrice,selectedDate,searchTitle,currentPage]);
  ...
  const fetchEvents = async () => {
    try {
      const response:EventFetchResponse = await eventRepository.getOrganiserEvents(params.toString());
