...
const fetchEventCreated=async()=>{
  ...
  const handleSubmit = async () => {
    ...
    if (selectedImageFile) {
      ...
      const response = await organiserRepository.updateOrganiser(formDataToSend,organiser?.id)
          ...
          <div className="relative px-6 pb-6">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="relative -mt-16">
                <div className="w-32 h-32 rounded-full border-4 border-white overflow-hidden bg-white">
                  <img src={profileImage?`http://localhost:3000/uploads/${profileImage}`: 'https://dummyimage.com/128x128/cccccc/ffffff&text=Organiser'} />
                ...
                <div className="flex items-center justify-between">
                  <div>
                    {isEditing ? (
                      ...
                      <h1 className="text-2xl font-bold text-gray-900">{organiserData.name}</h1>
                    )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
              <div className="bg-blue-50 rounded-xl p-4">
                <div className="text-blue-600 text-sm font-medium">Events Created</div>
                <div className="text-2xl font-bold text-blue-900">{organiserStats.count}</div>
              </div>
