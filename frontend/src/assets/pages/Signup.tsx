      ...
      >
        ...
        <div className="bg-white bg-opacity-90 backdrop-blur-md p-8 rounded-2xl shadow-lg w-full max-w-md">
          ...
          <div className="flex justify-center mb-6">
            <button
              className={`px-4 py-2 rounded-l-lg ${userType === 'user' ? 'bg-black text-white' : 'bg-gray-200'}`}
              onClick={() => setUserType('user')}
            >
              User
            </button>
            <button
              className={`px-4 py-2 rounded-r-lg ${userType === 'organizer' ? 'bg-black text-white' : 'bg-gray-200'}`}
