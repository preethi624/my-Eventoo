...
import { Search, Download, UserCheck, Mail, Calendar, Users, DollarSign, Ticket, Filter, MoreVertical, QrCode, MessageSquare, IndianRupee } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Event Attendees</h1>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  <th className="text-left py-4 px-6 font-semibold text-gray-900">Attendee</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-900">Contact</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-900">Tickets</th>
                 
                  <th className="text-left py-4 px-6 font-semibold text-gray-900">Booking Date</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-900">Amount</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-900">BookingStatus</th>
                 
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                {attendees.map((attendee) => (
                  <tr key={attendee.id} className="hover:bg-gray-50 transition-colors duration-150">
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">ID: {attendee.orderId}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-4 px-6">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-700">{new Date(attendee.createdAt).toLocaleDateString()}</span>
                      </div>
                    </td>
                    <td className="py-4 px-6">
                      <span className="font-semibold text-gray-900">${attendee.amount/100}</span>
                    </td>
                    <td className="py-4 px-6">
