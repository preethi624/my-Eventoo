...
export const loginUserWithGoogle =
  (credentialResponse: CredentialResponse) => async (dispatch: AppDispatch) => {
    try {
...
export const loginOrganiserWithGoogle =
  (credentialResponse: CredentialResponse) => async (dispatch: AppDispatch) => {
    try {
      const data = await authRepository.loginOrganiserWithGoogle(
        credentialResponse
      );
